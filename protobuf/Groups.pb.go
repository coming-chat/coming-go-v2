...
const (
	...
	Member_DEFAULT       Member_Role = 1 // Normal member
	Member_ADMINISTRATOR Member_Role = 2 // Group admin
	Member_OWNER         Member_Role = 3 // Group owner
)
...
const (
	...
	AccessControl_MEMBER        AccessControl_AccessRequired = 2 // Any group member can make the modification
	AccessControl_ADMINISTRATOR AccessControl_AccessRequired = 3 // Only administrators can make the modification
...
type Member struct {
	...
	UserId           []byte      `protobuf:"bytes,1,opt,name=userId,proto3" json:"userId,omitempty"` // The UuidCiphertext
	Role             Member_Role `protobuf:"varint,2,opt,name=role,proto3,enum=Member_Role" json:"role,omitempty"`
	ProfileKey       []byte      `protobuf:"bytes,3,opt,name=profileKey,proto3" json:"profileKey,omitempty"`              // The ProfileKeyCiphertext
	Presentation     []byte      `protobuf:"bytes,4,opt,name=presentation,proto3" json:"presentation,omitempty"`          // ProfileKeyCredentialPresentation
	JoinedAtRevision uint32      `protobuf:"varint,5,opt,name=joinedAtRevision,proto3" json:"joinedAtRevision,omitempty"` // The Group.revision this member joined at
}
...
type PendingMember struct {
	...
	Member        *Member `protobuf:"bytes,1,opt,name=member,proto3" json:"member,omitempty"`               // The “invited” member
	AddedByUserId []byte  `protobuf:"bytes,2,opt,name=addedByUserId,proto3" json:"addedByUserId,omitempty"` // The UID who invited this member
	Timestamp     uint64  `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`        // The time the invitation occurred
}
...
type AccessControl struct {
	...
	Attributes        AccessControl_AccessRequired `protobuf:"varint,1,opt,name=attributes,proto3,enum=AccessControl_AccessRequired" json:"attributes,omitempty"` // Who can modify the group title, avatar, disappearing messages timer
	Members           AccessControl_AccessRequired `protobuf:"varint,2,opt,name=members,proto3,enum=AccessControl_AccessRequired" json:"members,omitempty"`       // Who can add people to the group
...
type Group struct {
	...
	PublicKey                 []byte              `protobuf:"bytes,1,opt,name=publicKey,proto3" json:"publicKey,omitempty"`                                 // GroupPublicParams
	Title                     []byte              `protobuf:"bytes,2,opt,name=title,proto3" json:"title,omitempty"`                                         // Encrypted title
	Avatar                    string              `protobuf:"bytes,3,opt,name=avatar,proto3" json:"avatar,omitempty"`                                       // Pointer to encrypted avatar (‘key’ from AvatarUploadAttributes)
	DisappearingMessagesTimer []byte              `protobuf:"bytes,4,opt,name=disappearingMessagesTimer,proto3" json:"disappearingMessagesTimer,omitempty"` // Encrypted timer
	AccessControl             *AccessControl      `protobuf:"bytes,5,opt,name=accessControl,proto3" json:"accessControl,omitempty"`
	Revision                  uint32              `protobuf:"varint,6,opt,name=revision,proto3" json:"revision,omitempty"` // Current group revision number
...
type GroupChange struct {
	...
	Actions         []byte `protobuf:"bytes,1,opt,name=actions,proto3" json:"actions,omitempty"`                 // The serialized actions
	ServerSignature []byte `protobuf:"bytes,2,opt,name=serverSignature,proto3" json:"serverSignature,omitempty"` // Server’s signature over serialized actions
...
type GroupUsers struct {
	...
	Data []*GroupUsers_GroupUser `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty"`
}

func (x *GroupUsers) Reset() {
	*x = GroupUsers{}
	if protoimpl.UnsafeEnabled {
...
func (x *GroupUsers) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GroupUsers) ProtoMessage() {}

func (x *GroupUsers) ProtoReflect() protoreflect.Message {
	mi := &file_Groups_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GroupUsers.ProtoReflect.Descriptor instead.
func (*GroupUsers) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{8}
}

func (x *GroupUsers) GetData() []*GroupUsers_GroupUser {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *GroupInviteLink) GetContentsV1() *GroupInviteLink_GroupInviteLinkContentsV1 {
	if x, ok := x.GetContents().(*GroupInviteLink_ContentsV1); ok {
		return x.ContentsV1
	}
	return nil
}

func (x *GroupInviteLink) GetContentsV2() *GroupInviteLink_GroupInviteLinkContentsV2 {
	if x, ok := x.GetContents().(*GroupInviteLink_ContentsV2); ok {
		return x.ContentsV2
	}
	return nil
}
...
type GroupInviteLink_ContentsV2 struct {
	ContentsV2 *GroupInviteLink_GroupInviteLinkContentsV2 `protobuf:"bytes,2,opt,name=contentsV2,proto3,oneof"`
}

func (*GroupInviteLink_ContentsV1) isGroupInviteLink_Contents() {}

func (*GroupInviteLink_ContentsV2) isGroupInviteLink_Contents() {}
...
type GroupChange_Actions struct {
	...
	SourceUuid                      []byte                                                          `protobuf:"bytes,1,opt,name=sourceUuid,proto3" json:"sourceUuid,omitempty"`                                            // Who made the change
	Revision                        uint32                                                          `protobuf:"varint,2,opt,name=revision,proto3" json:"revision,omitempty"`                                               // The change revision number
	AddMembers                      []*GroupChange_Actions_AddMemberAction                          `protobuf:"bytes,3,rep,name=addMembers,proto3" json:"addMembers,omitempty"`                                            // Members added
	DeleteMembers                   []*GroupChange_Actions_DeleteMemberAction                       `protobuf:"bytes,4,rep,name=deleteMembers,proto3" json:"deleteMembers,omitempty"`                                      // Members deleted
	ModifyMemberRoles               []*GroupChange_Actions_ModifyMemberRoleAction                   `protobuf:"bytes,5,rep,name=modifyMemberRoles,proto3" json:"modifyMemberRoles,omitempty"`                              // Modified member roles
	ModifyMemberProfileKeys         []*GroupChange_Actions_ModifyMemberProfileKeyAction             `protobuf:"bytes,6,rep,name=modifyMemberProfileKeys,proto3" json:"modifyMemberProfileKeys,omitempty"`                  // Modified member profile keys
	AddPendingMembers               []*GroupChange_Actions_AddPendingMemberAction                   `protobuf:"bytes,7,rep,name=addPendingMembers,proto3" json:"addPendingMembers,omitempty"`                              // Pending members added
	DeletePendingMembers            []*GroupChange_Actions_DeletePendingMemberAction                `protobuf:"bytes,8,rep,name=deletePendingMembers,proto3" json:"deletePendingMembers,omitempty"`                        // Pending members deleted
	PromotePendingMembers           []*GroupChange_Actions_PromotePendingMemberAction               `protobuf:"bytes,9,rep,name=promotePendingMembers,proto3" json:"promotePendingMembers,omitempty"`                      // Pending invitations accepted
	ModifyTitle                     *GroupChange_Actions_ModifyTitleAction                          `protobuf:"bytes,10,opt,name=modifyTitle,proto3" json:"modifyTitle,omitempty"`                                         // Changed title
	ModifyAvatar                    *GroupChange_Actions_ModifyAvatarAction                         `protobuf:"bytes,11,opt,name=modifyAvatar,proto3" json:"modifyAvatar,omitempty"`                                       // Changed avatar
	ModifyDisappearingMessagesTimer *GroupChange_Actions_ModifyDisappearingMessagesTimerAction      `protobuf:"bytes,12,opt,name=modifyDisappearingMessagesTimer,proto3" json:"modifyDisappearingMessagesTimer,omitempty"` // Changed timer
	ModifyAttributesAccess          *GroupChange_Actions_ModifyAttributesAccessControlAction        `protobuf:"bytes,13,opt,name=modifyAttributesAccess,proto3" json:"modifyAttributesAccess,omitempty"`                   // Changed attributes access control
	ModifyMemberAccess              *GroupChange_Actions_ModifyMembersAccessControlAction           `protobuf:"bytes,14,opt,name=modifyMemberAccess,proto3" json:"modifyMemberAccess,omitempty"`                           // Changed membership access control
	...
	ModifyBannedMsg                 *GroupChange_Actions_ModifyBannedMsgAction                      `protobuf:"bytes,20,opt,name=modifyBannedMsg,proto3" json:"modifyBannedMsg,omitempty"`
}
...
func (*GroupChange_Actions) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0}
}
...
func (x *GroupChange_Actions) GetModifyBannedMsg() *GroupChange_Actions_ModifyBannedMsgAction {
	if x != nil {
		return x.ModifyBannedMsg
	}
	return nil
}
...
func (*GroupChange_Actions_AddMemberAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 0}
}
...
func (*GroupChange_Actions_DeleteMemberAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 1}
}
...
func (*GroupChange_Actions_ModifyMemberRoleAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 2}
}
...
func (*GroupChange_Actions_ModifyMemberProfileKeyAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 3}
}
...
func (*GroupChange_Actions_AddPendingMemberAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 4}
}
...
func (*GroupChange_Actions_DeletePendingMemberAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 5}
}
...
func (*GroupChange_Actions_PromotePendingMemberAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 6}
}
...
func (*GroupChange_Actions_AddRequestingMemberAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 7}
}
...
func (*GroupChange_Actions_DeleteRequestingMemberAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 8}
}
...
func (*GroupChange_Actions_PromoteRequestingMemberAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 9}
}
...
func (*GroupChange_Actions_ModifyTitleAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 10}
}
...
func (*GroupChange_Actions_ModifyAvatarAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 11}
}
...
func (*GroupChange_Actions_ModifyDisappearingMessagesTimerAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 12}
}
...
func (*GroupChange_Actions_ModifyAttributesAccessControlAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 13}
}
...
type GroupChange_Actions_ModifyAvatarAccessControlAction struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	AvatarAccess AccessControl_AccessRequired `protobuf:"varint,1,opt,name=avatarAccess,proto3,enum=AccessControl_AccessRequired" json:"avatarAccess,omitempty"`
}

func (x *GroupChange_Actions_ModifyAvatarAccessControlAction) Reset() {
	*x = GroupChange_Actions_ModifyAvatarAccessControlAction{}
	if protoimpl.UnsafeEnabled {
...
func (x *GroupChange_Actions_ModifyAvatarAccessControlAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GroupChange_Actions_ModifyAvatarAccessControlAction) ProtoMessage() {}

func (x *GroupChange_Actions_ModifyAvatarAccessControlAction) ProtoReflect() protoreflect.Message {
	mi := &file_Groups_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GroupChange_Actions_ModifyAvatarAccessControlAction.ProtoReflect.Descriptor instead.
func (*GroupChange_Actions_ModifyAvatarAccessControlAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 14}
}

func (x *GroupChange_Actions_ModifyAvatarAccessControlAction) GetAvatarAccess() AccessControl_AccessRequired {
	if x != nil {
		return x.AvatarAccess
	}
	return AccessControl_UNKNOWN
}
...
func (*GroupChange_Actions_ModifyMembersAccessControlAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 15}
}
...
func (*GroupChange_Actions_ModifyAddFromInviteLinkAccessControlAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 16}
}
...
func (*GroupChange_Actions_ModifyInviteLinkPasswordAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 17}
}
...
type GroupChange_Actions_ModifyBannedMsgAction struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BannedMsg uint32 `protobuf:"varint,1,opt,name=bannedMsg,proto3" json:"bannedMsg,omitempty"`
}

func (x *GroupChange_Actions_ModifyBannedMsgAction) Reset() {
	*x = GroupChange_Actions_ModifyBannedMsgAction{}
	if protoimpl.UnsafeEnabled {
...
func (x *GroupChange_Actions_ModifyBannedMsgAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GroupChange_Actions_ModifyBannedMsgAction) ProtoMessage() {}

func (x *GroupChange_Actions_ModifyBannedMsgAction) ProtoReflect() protoreflect.Message {
	mi := &file_Groups_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GroupChange_Actions_ModifyBannedMsgAction.ProtoReflect.Descriptor instead.
func (*GroupChange_Actions_ModifyBannedMsgAction) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{6, 0, 18}
}

func (x *GroupChange_Actions_ModifyBannedMsgAction) GetBannedMsg() uint32 {
	if x != nil {
		return x.BannedMsg
	}
	return 0
...
type GroupUsers_GroupUser struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ProfileKey string `protobuf:"bytes,1,opt,name=profileKey,proto3" json:"profileKey,omitempty"`
...
func (x *GroupUsers_GroupUser) Reset() {
	*x = GroupUsers_GroupUser{}
	if protoimpl.UnsafeEnabled {
...
func (x *GroupUsers_GroupUser) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GroupUsers_GroupUser) ProtoMessage() {}

func (x *GroupUsers_GroupUser) ProtoReflect() protoreflect.Message {
	mi := &file_Groups_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GroupUsers_GroupUser.ProtoReflect.Descriptor instead.
func (*GroupUsers_GroupUser) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{8, 0}
}

func (x *GroupUsers_GroupUser) GetProfileKey() string {
	if x != nil {
		return x.ProfileKey
	}
	return ""
...
func (x *GroupUsers_GroupUser) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *GroupUsers_GroupUser) GetUserCid() string {
	if x != nil {
		return x.UserCid
	}
	return ""
...
func (x *GroupUsers_GroupUser) GetUserType() uint32 {
	if x != nil {
		return x.UserType
	}
	return 0
...
type GroupInviteLink_GroupInviteLinkContentsV2 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GroupInviteLink_GroupInviteLinkContentsV2) Reset() {
	*x = GroupInviteLink_GroupInviteLinkContentsV2{}
	if protoimpl.UnsafeEnabled {
...
func (x *GroupInviteLink_GroupInviteLinkContentsV2) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GroupInviteLink_GroupInviteLinkContentsV2) ProtoMessage() {}

func (x *GroupInviteLink_GroupInviteLinkContentsV2) ProtoReflect() protoreflect.Message {
	mi := &file_Groups_proto_msgTypes[36]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GroupInviteLink_GroupInviteLinkContentsV2.ProtoReflect.Descriptor instead.
func (*GroupInviteLink_GroupInviteLinkContentsV2) Descriptor() ([]byte, []int) {
	return file_Groups_proto_rawDescGZIP(), []int{10, 1}
}

func (x *GroupInviteLink_GroupInviteLinkContentsV2) GetGroupMasterKey() []byte {
	if x != nil {
		return x.GroupMasterKey
	}
	return nil
...
func (x *GroupInviteLink_GroupInviteLinkContentsV2) GetInviteLinkPassword() []byte {
	if x != nil {
		return x.InviteLinkPassword
	}
	return nil
...
func (x *GroupInviteLink_GroupInviteLinkContentsV2) GetRoomId() uint32 {
	if x != nil {
		return x.RoomId
	}
	return 0
...
var file_Groups_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xf2, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	...
	0x41, 0x74, 0x52, 0x65, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x3e, 0x0a, 0x04, 0x52, 0x6f,
	...
	0x41, 0x44, 0x4d, 0x49, 0x4e, 0x49, 0x53, 0x54, 0x52, 0x41, 0x54, 0x4f, 0x52, 0x10, 0x02, 0x12,
	0x09, 0x0a, 0x05, 0x4f, 0x57, 0x4e, 0x45, 0x52, 0x10, 0x03, 0x22, 0x74, 0x0a, 0x0d, 0x50, 0x65,
	0x6e, 0x64, 0x69, 0x6e, 0x67, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x1f, 0x0a, 0x06, 0x6d,
	...
	0x22, 0x8c, 0x01, 0x0a, 0x10, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x4d,
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1e, 0x0a,
	0x0a, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x4b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x0a, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x4b, 0x65, 0x79, 0x12, 0x22, 0x0a,
	0x0c, 0x70, 0x72, 0x65, 0x73, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20,
	...
	0xae, 0x02, 0x0a, 0x0d, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f,
	0x6c, 0x12, 0x3d, 0x0a, 0x0a, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x43, 0x6f,
	0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x2e, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x69, 0x72, 0x65, 0x64, 0x52, 0x0a, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73,
	0x12, 0x37, 0x0a, 0x07, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x52, 0x07, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x12, 0x4b, 0x0a, 0x11, 0x61, 0x64, 0x64,
	...
	,
	...
	0x6e, 0x67, 0x65, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x1a, 0x9b, 0x1a, 0x0a, 0x07, 0x41, 0x63, 0x74,
	...
	,
	...
	,
	...
	0x1a, 0x3e, 0x0a, 0x16, 0x41, 0x64, 0x64, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x4d, 0x65,
	0x6d, 0x62, 0x65, 0x72, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x24, 0x0a, 0x05, 0x61, 0x64,
	0x64, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x50, 0x65, 0x6e, 0x64,
	0x69, 0x6e, 0x67, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x05, 0x61, 0x64, 0x64, 0x65, 0x64,
	0x1a, 0x41, 0x0a, 0x19, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e,
	...
	,
	...
	0x12, 0x43, 0x0a, 0x0d, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x41, 0x63, 0x63, 0x65, 0x73,
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x2e, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65,
	0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x52, 0x0d, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x41,
	0x63, 0x63, 0x65, 0x73, 0x73, 0x1a, 0x85, 0x01, 0x0a, 0x2a, 0x4d, 0x6f, 0x64, 0x69, 0x66, 0x79,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x73, 0x56, 0x32, 0x48, 0x00, 0x52, 0x0a, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73,
	0x56, 0x32, 0x1a, 0x73, 0x0a, 0x19, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x6e, 0x76, 0x69, 0x74,
	...
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x1a, 0x8b, 0x01, 0x0a, 0x19, 0x47, 0x72, 0x6f, 0x75,
	0x70, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x43, 0x6f, 0x6e, 0x74, 0x65,
	0x6e, 0x74, 0x73, 0x56, 0x32, 0x12, 0x26, 0x0a, 0x0e, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x4d, 0x61,
	...
	0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x16, 0x0a,
	0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x72,
	0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x42, 0x0a, 0x0a, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74,
	0x73, 0x22, 0x9a, 0x02, 0x0a, 0x0d, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x4a, 0x6f, 0x69, 0x6e, 0x49,
	...
	0x79, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c,
	...
	0x74, 0x12, 0x4b, 0x0a, 0x11, 0x61, 0x64, 0x64, 0x46, 0x72, 0x6f, 0x6d, 0x49, 0x6e, 0x76, 0x69,
	0x74, 0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x41,
	...
	,
...
var file_Groups_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_Groups_proto_goTypes = []interface{}{
	...
	(*AccessControl)(nil),                                                  // 6: AccessControl
	(*Group)(nil),                                                          // 7: Group
	(*GroupChange)(nil),                                                    // 8: GroupChange
	(*GroupChanges)(nil),                                                   // 9: GroupChanges
	(*GroupUsers)(nil),                                                     // 10: GroupUsers
	...
	(*GroupChange_Actions_AddRequestingMemberAction)(nil),                  // 23: GroupChange.Actions.AddRequestingMemberAction
	(*GroupChange_Actions_DeleteRequestingMemberAction)(nil),               // 24: GroupChange.Actions.DeleteRequestingMemberAction
	(*GroupChange_Actions_PromoteRequestingMemberAction)(nil),              // 25: GroupChange.Actions.PromoteRequestingMemberAction
	(*GroupChange_Actions_ModifyTitleAction)(nil),                          // 26: GroupChange.Actions.ModifyTitleAction
	(*GroupChange_Actions_ModifyAvatarAction)(nil),                         // 27: GroupChange.Actions.ModifyAvatarAction
	(*GroupChange_Actions_ModifyDisappearingMessagesTimerAction)(nil),      // 28: GroupChange.Actions.ModifyDisappearingMessagesTimerAction
	(*GroupChange_Actions_ModifyAttributesAccessControlAction)(nil),        // 29: GroupChange.Actions.ModifyAttributesAccessControlAction
	(*GroupChange_Actions_ModifyAvatarAccessControlAction)(nil),            // 30: GroupChange.Actions.ModifyAvatarAccessControlAction
	(*GroupChange_Actions_ModifyMembersAccessControlAction)(nil),           // 31: GroupChange.Actions.ModifyMembersAccessControlAction
	(*GroupChange_Actions_ModifyAddFromInviteLinkAccessControlAction)(nil), // 32: GroupChange.Actions.ModifyAddFromInviteLinkAccessControlAction
	(*GroupChange_Actions_ModifyInviteLinkPasswordAction)(nil),             // 33: GroupChange.Actions.ModifyInviteLinkPasswordAction
	(*GroupChange_Actions_ModifyBannedMsgAction)(nil),                      // 34: GroupChange.Actions.ModifyBannedMsgAction
	(*GroupChanges_GroupChangeState)(nil),                                  // 35: GroupChanges.GroupChangeState
	(*GroupUsers_GroupUser)(nil),                                           // 36: GroupUsers.GroupUser
	(*GroupInviteLink_GroupInviteLinkContentsV1)(nil),                      // 37: GroupInviteLink.GroupInviteLinkContentsV1
	(*GroupInviteLink_GroupInviteLinkContentsV2)(nil),                      // 38: GroupInviteLink.GroupInviteLinkContentsV2
}
var file_Groups_proto_depIdxs = []int32{
	...
	6,  // 5: Group.accessControl:type_name -> AccessControl
	...
	35, // 9: GroupChanges.groupChanges:type_name -> GroupChanges.GroupChangeState
	36, // 10: GroupUsers.data:type_name -> GroupUsers.GroupUser
	37, // 11: GroupInviteLink.contentsV1:type_name -> GroupInviteLink.GroupInviteLinkContentsV1
	38, // 12: GroupInviteLink.contentsV2:type_name -> GroupInviteLink.GroupInviteLinkContentsV2
	1,  // 13: GroupJoinInfo.addFromInviteLink:type_name -> AccessControl.AccessRequired
	16, // 14: GroupChange.Actions.addMembers:type_name -> GroupChange.Actions.AddMemberAction
	17, // 15: GroupChange.Actions.deleteMembers:type_name -> GroupChange.Actions.DeleteMemberAction
	18, // 16: GroupChange.Actions.modifyMemberRoles:type_name -> GroupChange.Actions.ModifyMemberRoleAction
	19, // 17: GroupChange.Actions.modifyMemberProfileKeys:type_name -> GroupChange.Actions.ModifyMemberProfileKeyAction
	20, // 18: GroupChange.Actions.addPendingMembers:type_name -> GroupChange.Actions.AddPendingMemberAction
	21, // 19: GroupChange.Actions.deletePendingMembers:type_name -> GroupChange.Actions.DeletePendingMemberAction
	22, // 20: GroupChange.Actions.promotePendingMembers:type_name -> GroupChange.Actions.PromotePendingMemberAction
	26, // 21: GroupChange.Actions.modifyTitle:type_name -> GroupChange.Actions.ModifyTitleAction
	27, // 22: GroupChange.Actions.modifyAvatar:type_name -> GroupChange.Actions.ModifyAvatarAction
	28, // 23: GroupChange.Actions.modifyDisappearingMessagesTimer:type_name -> GroupChange.Actions.ModifyDisappearingMessagesTimerAction
	29, // 24: GroupChange.Actions.modifyAttributesAccess:type_name -> GroupChange.Actions.ModifyAttributesAccessControlAction
	31, // 25: GroupChange.Actions.modifyMemberAccess:type_name -> GroupChange.Actions.ModifyMembersAccessControlAction
	32, // 26: GroupChange.Actions.modifyAddFromInviteLinkAccess:type_name -> GroupChange.Actions.ModifyAddFromInviteLinkAccessControlAction
	23, // 27: GroupChange.Actions.addRequestingMembers:type_name -> GroupChange.Actions.AddRequestingMemberAction
	24, // 28: GroupChange.Actions.deleteRequestingMembers:type_name -> GroupChange.Actions.DeleteRequestingMemberAction
	25, // 29: GroupChange.Actions.promoteRequestingMembers:type_name -> GroupChange.Actions.PromoteRequestingMemberAction
	33, // 30: GroupChange.Actions.modifyInviteLinkPassword:type_name -> GroupChange.Actions.ModifyInviteLinkPasswordAction
	34, // 31: GroupChange.Actions.modifyBannedMsg:type_name -> GroupChange.Actions.ModifyBannedMsgAction
	3,  // 32: GroupChange.Actions.AddMemberAction.added:type_name -> Member
	0,  // 33: GroupChange.Actions.ModifyMemberRoleAction.role:type_name -> Member.Role
	4,  // 34: GroupChange.Actions.AddPendingMemberAction.added:type_name -> PendingMember
	5,  // 35: GroupChange.Actions.AddRequestingMemberAction.added:type_name -> RequestingMember
	0,  // 36: GroupChange.Actions.PromoteRequestingMemberAction.role:type_name -> Member.Role
	1,  // 37: GroupChange.Actions.ModifyAttributesAccessControlAction.attributesAccess:type_name -> AccessControl.AccessRequired
	1,  // 38: GroupChange.Actions.ModifyAvatarAccessControlAction.avatarAccess:type_name -> AccessControl.AccessRequired
	1,  // 39: GroupChange.Actions.ModifyMembersAccessControlAction.membersAccess:type_name -> AccessControl.AccessRequired
	1,  // 40: GroupChange.Actions.ModifyAddFromInviteLinkAccessControlAction.addFromInviteLinkAccess:type_name -> AccessControl.AccessRequired
	8,  // 41: GroupChanges.GroupChangeState.groupChange:type_name -> GroupChange
	7,  // 42: GroupChanges.GroupChangeState.groupState:type_name -> Group
...
func file_Groups_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_Groups_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GroupChange_Actions_ModifyAvatarAccessControlAction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_Groups_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GroupChange_Actions_ModifyBannedMsgAction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_Groups_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GroupUsers_GroupUser); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_Groups_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GroupInviteLink_GroupInviteLinkContentsV2); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_Groups_proto_msgTypes[10].OneofWrappers = []interface{}{
		...
		(*GroupInviteLink_ContentsV2)(nil),
	}
	type x struct{}
